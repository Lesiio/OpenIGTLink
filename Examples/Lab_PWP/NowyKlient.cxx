...
int main(int argc, char* argv[])
{
	...
	while (1)
	{
		...
		if (strcmp(headerMsg->GetDeviceName(), "PointSender") == 0)
		{
			...
			std::cerr << "Receiving Point data type. pierwsze zdanie" << std::endl;
...
int ReceivePoint(igtl::Socket * socket, igtl::MessageHeader * header)
{
	...
	std::cerr << "Receiving POINT data type. Drugie zdanie" << std::endl;
	...
	if (c & igtl::MessageHeader::UNPACK_BODY) // if CRC check is OK
	{
		...
		std::cerr << pointMsg->GetNumberOfPointElement() << std::endl;
